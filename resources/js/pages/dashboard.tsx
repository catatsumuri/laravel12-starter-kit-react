                ...
                <section className="space-y-4">
                    ...
                    <div className="grid auto-rows-min gap-4 md:grid-cols-3">
                        {[
                            {
                                title: t(
                                    'dashboard.highlights.performance.title',
                                ),
                                description: t(
                                    'dashboard.highlights.performance.description',
                                ),
                            },
                            {
                                title: t('dashboard.highlights.adoption.title'),
                                description: t(
                                    'dashboard.highlights.adoption.description',
                                ),
                            },
                            {
                                title: t('dashboard.highlights.support.title'),
                                description: t(
                                    'dashboard.highlights.support.description',
                                ),
                            },
                        ].map((card) => (
                            <section
                        ...
                        {[
                            {
                                ...
                                description: t(
                                    'dashboard.insights.roadmap.description',
                                ),
                            },
                            {
                                title: t('dashboard.insights.revenue.title'),
                                description: t(
                                    'dashboard.insights.revenue.description',
                                ),
                            },
                            {
                                title: t('dashboard.insights.retention.title'),
                                description: t(
                                    'dashboard.insights.retention.description',
                                ),
                            },
                            {
                                title: t('dashboard.insights.team.title'),
                                description: t(
                                    'dashboard.insights.team.description',
                                ),
                            },
                        ].map((item) => (
                            <article
